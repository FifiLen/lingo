...
const DashboardElements = () => {
  return (
    <div className="max-w-5xl flex flex-wrap flex-initial gap-4">
        ...
        <Link to={"/saved"}>
            <div className=" p-4 border rounded-md">
                    ...
                    <div className=" flex items-center gap-10">
                        ...
                        <p className=" text-sm text-primary-500">Ustawienia →</p>
                    </div>
            </div>
        </Link>
        ...
        <Link to={"/explore"}>
            <div className=" p-4 border rounded-md">
                    ...
                    <div className=" flex items-center gap-10">
                        ...
                        <p className=" text-sm text-primary-500">Zacznij rozmowę →</p>
                    </div>
            </div>
        </Link>
        ...
        <Link to={"/all-users"}>
            <div className=" p-4 border rounded-md">
                    ...
                    <div className=" flex items-center gap-10">
                        ...
                        <p className=" text-sm text-primary-500">Zadania →</p>
                    </div>
            </div>
        </Link>
            ...
            <div className=" p-4 border rounded-md">
                    ...
                    <div className=" flex items-center gap-10">
                        ...
                        <p className=" text-sm text-primary-500">Pomoc →</p>
                    </div>
            </div>
        </Link>
